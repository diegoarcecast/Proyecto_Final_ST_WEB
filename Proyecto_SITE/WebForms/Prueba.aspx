<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prueba.aspx.cs" Inherits="Proyecto_SITE.WebForms.Prueba" %>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="w3-white" id="ProximosEventos">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      <h2 class="w3-wide w3-center">Administrar Usuarios</h2>
      <p class="w3-opacity w3-center">Prueba</p><br />

      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px" >
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="i_PK_idUsuario" DataSourceID="SqlDataSource1">
              <Columns>
                  <asp:BoundField DataField="i_PK_idUsuario" HeaderText="i_PK_idUsuario" InsertVisible="False" ReadOnly="True" SortExpression="i_PK_idUsuario" />
                  <asp:BoundField DataField="vc_nombreUsuario" HeaderText="vc_nombreUsuario" SortExpression="vc_nombreUsuario" />
                  <asp:BoundField DataField="vc_notasUsuario" HeaderText="vc_notasUsuario" SortExpression="vc_notasUsuario" />
                  <asp:BoundField DataField="vc_telefonoUsuario" HeaderText="vc_telefonoUsuario" SortExpression="vc_telefonoUsuario" />
                  <asp:BoundField DataField="vc_correoUsuario" HeaderText="vc_correoUsuario" SortExpression="vc_correoUsuario" />
                  <asp:BoundField DataField="vc_claveUsuario" HeaderText="vc_claveUsuario" SortExpression="vc_claveUsuario" />
                  <asp:CheckBoxField DataField="b_activoUsuario" HeaderText="b_activoUsuario" SortExpression="b_activoUsuario" />
              </Columns>
          </asp:GridView>

          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SpecialTicketConnectionString %>" SelectCommand="SELECT * FROM [usr_Usuario]"></asp:SqlDataSource>
