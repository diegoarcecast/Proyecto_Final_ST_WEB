<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfrm_Cat_Zona.aspx.cs" Inherits="Proyecto_SITE.WebForms.wfrm_Cat_Zona" %>
  ...
  <div class="w3-white" id="ProximosEventos">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px" >
          <asp:GridView ID="grv_Zona" runat="server" AutoGenerateColumns="False">
               <Columns>
                        <asp:BoundField DataField="i_PK_idZona" HeaderText="ID" />
                        <asp:BoundField DataField="vc_nombreZona" HeaderText="Nombre Zona" />
                        <asp:BoundField DataField="i_FK_idTipoZona" HeaderText="Tipo Zona" />
                    </Columns>
          </asp:GridView>
