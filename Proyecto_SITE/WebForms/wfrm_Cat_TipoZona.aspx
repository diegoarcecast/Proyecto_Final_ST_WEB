<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfrm_Cat_TipoZona.aspx.cs" Inherits="Proyecto_SITE.WebForms.wfrm_Cat_TipoZona" %>
  ...
  <div class="w3-white" id="ProximosEventos">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px" >
          <asp:GridView ID="grv_TipoZona" runat="server" AutoGenerateColumns="False">
               <Columns>
                        <asp:BoundField DataField="i_PK_idTipoZona" HeaderText="ID Tipo Zona" />
                        <asp:BoundField DataField="vc_nombreTipoZona" HeaderText="Nombre Tipo Zona" />
                        <asp:BoundField DataField="vc_descripcionTipoZona" HeaderText="Descripcion Tipo Zona" />
                    </Columns>
          </asp:GridView>
