...
namespace Proyecto_SITE.ServiceReference {
    ...
    public interface IBD {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBD/Modificar_Usuario", ReplyAction="http://tempuri.org/IBD/Modificar_UsuarioResponse")]
        System.Threading.Tasks.Task<string> Modificar_UsuarioAsync(string Correo, string Clave, string Nombre, string Notas, string Telefono, bool Notificaciones);
    ...
    public partial class BDClient : System.ServiceModel.ClientBase<Proyecto_SITE.ServiceReference.IBD>, Proyecto_SITE.ServiceReference.IBD {
        ...
        public string Modificar_Usuario(string Correo, string Clave, string Nombre, string Notas, string Telefono, bool Notificaciones) {
            return base.Channel.Modificar_Usuario(Correo, Clave, Nombre, Notas, Telefono, Notificaciones);
        }
        
        public System.Threading.Tasks.Task<string> Modificar_UsuarioAsync(string Correo, string Clave, string Nombre, string Notas, string Telefono, bool Notificaciones) {
            return base.Channel.Modificar_UsuarioAsync(Correo, Clave, Nombre, Notas, Telefono, Notificaciones);
        }
